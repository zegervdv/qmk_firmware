...
[1] = LAYOUT_75_ansi(
    ...
    _______,                LINK_TO,    _______,   RGB_TEST,   _______,     BAT_NUM,   _______,    MO(4),       RGB_SPD,   RGB_SPI,    _______,                 _______,    RGB_VAI,    _______,
...
[4] = LAYOUT_75_ansi(
    ...
    _______,    _______,    _______,    _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,                _______,    _______, 
    _______,    _______,    _______,    KB_DBG,    _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,                             _______,    _______,
